...
public class Country {
  ...
  public static final Country POLAND = new Country(1L, "Poland", "Warsaw", 38.186, Continent.EUROPE,
      313);
  public static final Country BELGIUM = new Country(2L, "Belgium", "Brussels", 11.007,
      Continent.EUROPE, 30);
  public static final Country SPAIN = new Country(3L, "Spain", "Madrid", 46.0, Continent.EUROPE,
      508);
  public static final Country ENGLAND = new Country(4L, "England", "London", 51.446,
      Continent.EUROPE, 130);
  public static final Country FINLAND_WITHOUT_CAPITAL_CITY = new Country(5L, "Finland", null, null,
      Continent.EUROPE,
      null);
  public static final Country SOUTH_AFRICA = new Country(9L, "South Africa", "Pretoria", 50.586,
      Continent.AFRICA,
      1221);
  public static final Country ICELAND = new Country(8L, "Iceland", "Reykjavik", 0.318,
      Continent.EUROPE, 103);
  ...
  public Country(Long id, String name, String capitalCity, Double population, Continent continent,
      Integer area) {
    this.id = id;
    this.name = name;
