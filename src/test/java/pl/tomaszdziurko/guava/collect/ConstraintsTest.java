...
/**
 * Constraints showcase has @Deprecated ,we encourage you to check your preconditions explicitly
...
public class ConstraintsTest {
  ...
  public void shouldThrowExceptionOnInvalidAdd() throws Exception {
    ...
    // given
    List<Integer> userAgesList = Constraints
        .constrainedList(Lists.newArrayList(1, 2, 3), element -> {
