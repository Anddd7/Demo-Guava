...
public class Collections2Test {
  ...
  public void shouldTransformCollection() throws Exception {
    ...
    // given
    ArrayList<Country> countries = Lists
        .newArrayList(Country.POLAND, Country.BELGIUM, Country.ENGLAND);
  ...
  public void shouldFilterCountriesOnlyFromAfrica() throws Exception {
    ...
    // given
    ArrayList<Country> countries = Lists
        .newArrayList(Country.POLAND, Country.BELGIUM, Country.SOUTH_AFRICA);

    // when
    Collection<Country> countriesFromAfrica = Collections2
        .filter(countries, new Predicate<Country>() {
