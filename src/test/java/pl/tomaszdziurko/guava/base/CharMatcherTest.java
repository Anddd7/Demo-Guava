...
public class CharMatcherTest {
  ...
  public void shouldRetainDigitsOrWhiteSpaces() throws Exception {
    assertThat(CharMatcher.DIGIT.or(CharMatcher.WHITESPACE).retainFrom("Hello 1234 567"))
        .isEqualTo(" 1234 567");
  }

  @Test
  public void shouldRetainNothingAsConstrainsAreExcluding() throws Exception {
    assertThat(CharMatcher.DIGIT.and(CharMatcher.JAVA_LETTER).retainFrom("Hello 1234 567"))
        .isEqualTo("");
  }
  ...
  public void shouldRemoveAllExceptDigitsBetween3and6() throws Exception {
    assertThat(CharMatcher.inRange('3', '6').negate().removeFrom("Hello 1234 567"))
        .isEqualTo("3456");
  }
