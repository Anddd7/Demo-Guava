...
/**
 * CaseFormat features : To convert String , like 'lower' -> 'UPPER' , '-hyphen' -> '_underscore' ,'lowerCamel' -> 'lowernormal'
 */
public class CaseFormatTest {
    ...
    public void shouldConvertToUpperUnderscore() throws Exception {
        ...
        // then
        assertThat(CaseFormat.UPPER_CAMEL.to(CaseFormat.UPPER_UNDERSCORE, "HelloWorld")).isEqualTo("HELLO_WORLD");
    }
    ...
    public void shouldConvertToLowerHyphen() throws Exception {
        ...
        // then
        assertThat(CaseFormat.LOWER_CAMEL.to(CaseFormat.LOWER_HYPHEN, "helloWorld")).isEqualTo("hello-world");
    }
}
